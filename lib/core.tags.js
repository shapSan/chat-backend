...
export function normalizePartnership(src = {}) {
  ...
  // Extract cast field and validate it
  const rawCast = firstMeaningful(src.main_cast, src.stars, src.talent, src.cast);
  ...
  return {
    ...
    // CRITICAL: Validate cast data to prevent synopsis text from appearing in cast field
