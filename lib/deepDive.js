...
2. Integration Paragraph (40-60 words) - Combine 2-3 distinct integration ideas into a single, flowing paragraph. Connect them naturally.
    ...
    if (response.ok) {
      ...
      if (isLite) {
        ...
        return {
          ...
          integrationIdeas: [ sections[2]?.trim() || 'No ideas generated.' ],
