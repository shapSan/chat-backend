...
Make the content creative, specific, and compelling. Focus on storytelling opportunities and marketing potential.`;
        ...
        // FINAL ID SANITIZATION: Ensure every brand has a valid, non-null string ID.
        // This is the single source of truth for IDs.
        ...
        add({ type: 'complete', text: `✅ IDs sanitized. Returning ${parsedBrands.length} brands.` });
        ...
        // NOW THE RETURN STATEMENT CAN PROCEED
        return {
          mcpThinking,
          organizedData: {
