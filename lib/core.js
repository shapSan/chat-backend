...
Return format:
{
  ...
  const finalPartnershipData = {
      ...
      // 👇 CRITICAL FIX: Prioritize 'main_cast' field from HubSpot, NEVER use AI-extracted cast 👇
      // The correct field from HubSpot is 'main_cast', not 'cast'
      cast: partnershipData?.main_cast || partnershipData?.cast || null,
