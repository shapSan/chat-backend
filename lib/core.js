...
Your ONLY job: Find brands that naturally fit THIS SPECIFIC story. IGNORE partnership counts and client status.
...
<CRITICAL_RULES>
1. Score brands 0-100 based ONLY on how naturally they fit THIS SPECIFIC PRODUCTION
2. Your "reason" MUST reference specific elements from the production (genre, synopsis, cast, or location)
3. NEVER give generic reasons like "fits the genre" - BE SPECIFIC
4. Example good reason: "Energy drink perfect for Quavo's street racing scenes in Miami"
5. Example bad reason: "Good for action scenes"
6. IGNORE all partnership/client data - only creative fit matters
</CRITICAL_RULES>

<OUTPUT_FORMAT>
Return a JSON object with a "brands" array containing the TOP 50 brands:
{
  "brands": [
    {
      "id": "brand_id",
      "score": 95,
      "reason": "SPECIFIC reason mentioning production details"
    }
  ]
}
</OUTPUT_FORMAT>

Rank ALL brands, return top 50. Reasons MUST be specific to THIS production.`;
