...
Return a single JSON object with the key "pitches", containing an array of objects. Each object should have keys "brandName", "integrationIdeas", "whyItWorks", and "hbInsights".`;
  } else {
...
CRITICAL: Return ONLY a valid JSON object with a single key "pitches". The value should be an array of objects, where each object represents a brand and has the keys "brandName", "integrationIdeas", "whyItWorks", and "hbInsights" based on the rules above.
`;
