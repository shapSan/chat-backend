...
async function runQuickMatchOrchestrator(
  ...
  try {
    ...
    return prepareFrontendPayload({
      ...
      mcpThinking,
      projectName: partnershipData.title || projectName,
      partnershipData,
      communications: { meetings: [], emails: [] },
      finalReplyText: creativeResult.finalReplyText || `Here are quick match suggestions for ${partnershipData.title || projectName}.`
    });
