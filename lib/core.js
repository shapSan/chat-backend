...
// Import what we need locally (they're also re-exported)
import { extractJson, extractLastProduction } from './core.utils.js';
...
// extractJson is now exported from core.utils.js
...
\`\`\``;
  ...
  // Step 4: Search communications for brand mentions
  ...
  // Step 5: Fetch brands from curated buckets
